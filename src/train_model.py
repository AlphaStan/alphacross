...
@click.option('--n-players', type=int, default=2, help="Number of players to simulate")
...
def train_agent(epsilon, net_name, n_players, discount, num_episodes, batch_size, num_replays, save_dir):
